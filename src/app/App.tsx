  ...
  return (
    <div style={{ backgroundColor: "#A9A7A8" }}>
      ...
      >
        ...
        <a href="https://52labs.co" target="_blank" rel="noopener noreferrer" className="text-[28px] font-medium text-black hover:opacity-60 transition-opacity" onClick={() => setMenuOpen(false)}>Labs</a>
        <a
      ...
      >
        ...
        <div className="hidden md:flex flex-row items-center gap-3 text-[17px] text-black">
          ...
          <span className="opacity-40 select-none flex items-center"><BulletIcon color="#000" /></span>
          <a href="https://52labs.co" target="_blank" rel="noopener noreferrer" className="hover:opacity-60 transition-opacity">Labs</a>
        </div>
